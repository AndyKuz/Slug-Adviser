...
ece_80t = course.Course(dptmnt='ECE', dptmnt_num='80T', course_title='Modern Technology and How It Works', num_credits=5, incoming_prereqs=[], quarters=[0, 1, 2], profs=[])
...
math_23a = course.Course(dptmnt='MATH', dptmnt_num='23A', course_title='Vector Calculus', num_credits=5, incoming_prereqs=[math_19b], quarters=[0, 1, 2], profs=[])
math_23b = course.Course(dptmnt='MATH', dptmnt_num='23B', course_title='Vector Calculus', num_credits=5, incoming_prereqs=[math_23a], quarters=[0, 1, 2], profs=[])
...
am_30 = course.Course(dptmnt='AM', dptmnt_num='30', course_title='Multivariate Calculus for Engineers', num_credits=5, incoming_prereqs=[math_19b], quarters=[0, 1, 2], profs=[])
stat_131 = course.Course(dptmnt='STAT', dptmnt_num='131', course_title='Introduction to Probability Theory', num_credits=5, incoming_prereqs=[math_19b], quarters=[0, 1, 2], profs=[])
...
ece_13 = course.Course(dptmnt='ece', dptmnt_num='13', course_title='Computer Systems and C Programming', num_credits=7, incoming_prereqs=[cse_12], quarters=[0, 1, 2], profs=[])
...
phys_5a = course.Course(dptmnt='PHYS', dptmnt_num='5A/L', course_title='Introduction to Physics I', num_credits=6, incoming_prereqs=[math_19b], quarters=[0, 1], profs=["Barun Dhar", "Steven Ritz"])
phys_5c = course.Course(dptmnt='PHYS', dptmnt_num='5C/N', course_title='Introduction to Physics III', num_credits=6, incoming_prereqs=[phys_5a, math_19b], quarters=[0, 1], profs=["Sriram Shastry", "Sergey Syzranov"])
phys_5b = course.Course(dptmnt='PHYS', dptmnt_num='5B/M', course_title='Introduction to Physics II', num_credits=6, incoming_prereqs=[phys_5a, math_19a], quarters=[2], profs=[])
phys_5d = course.Course(dptmnt='PHYS', dptmnt_num='5D', course_title='Introduction to Physics IV', num_credits=5, incoming_prereqs=[phys_5a, phys_5b], quarters=[0], profs=["Stefano Profumo"])
...
ece_102 = course.Course(dptmnt='ECE', dptmnt_num='102/L', course_title='Properties of Materials', num_credits=7, incoming_prereqs=[phys_5b, phys_5c], quarters=[0, 1, 2], profs=[])
ece_103 = course.Course(dptmnt='ECE', dptmnt_num='103/L', course_title='Signals and Systems', num_credits=7, incoming_prereqs=[ece_101, am_20], quarters=[0, 1, 2], profs=[])
ece_135 = course.Course(dptmnt='ECE', dptmnt_num='135/L', course_title='Electromagnetic Fields and Waves', num_credits=7, incoming_prereqs=[ece_101, am_20], quarters=[0, 1, 2], profs=[])
ece_151 = course.Course(dptmnt='ECE', dptmnt_num='151', course_title='Communications Systems', num_credits=5, incoming_prereqs=[ece_101, ece_103, stat_131], quarters=[0, 1, 2], profs=[])
ece_171 = course.Course(dptmnt='ECE', dptmnt_num='171', course_title='Analog Electronics', num_credits=7, incoming_prereqs=[ece_101], quarters=[0, 1, 2], profs=[])
...
cse_122 = course.Course(dptmnt='CSE', dptmnt_num='122', course_title='Introduction to VLSI Digital System Design', num_credits=5, incoming_prereqs=[cse_100, ece_101, math_23b, am_20], quarters=[1], profs=[])
...
schedule_maker.create_schedule(cs, [math_19a, math_19b, cse_20, cse_30, cse_12, cse_16, cse_13s, am_10, am_30,
                                     ece_30, cse_101, cse_102, cse_103, cse_120], 3, cs_placeholders)
