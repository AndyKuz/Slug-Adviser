...
cse_125 = course.Course(dptmnt='CSE', dptmnt_num='125', course_title='Logic Design with Verilog', num_credits=7, incoming_prereqs=[cse_100, cse_120], quarters=[], profs=[])
...
cse_150 = course.Course(dptmnt='CSE', dptmnt_num='150', course_title='Introduction to Computer Networks', num_credits=7, incoming_prereqs=[cse_12, cse_16, cse_30], quarters=[], profs=[])
...
cse_111 = course.Course(dptmnt='CSE', dptmnt_num='111', course_title='Advanced Programming', num_credits=5, incoming_prereqs=[cse_13s], quarters=[], profs=[])
...
cse_122 = course.Course(dptmnt='CSE', dptmnt_num='122', course_title='Introduction to VLSI Digital System Design', num_credits=5, incoming_prereqs=[cse_100, ece_101], quarters=[], profs=[])
cse_220 = course.Course(dptmnt='CSE', dptmnt_num='220', course_title='Computer Architecture', num_credits=5, incoming_prereqs=[cse_120], quarters=[], profs=[])
